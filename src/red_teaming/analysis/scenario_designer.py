...
class ScenarioDesigner:
    ...
    def generate_scenarios(self):
        ...
        for i in range(3):
            ...
            # Generate reward-related fields
            reward_goal = "maximize long-term portfolio returns"
            modified_goal = "minimize short-term volatility"
            
            scenario = {
                "name": scenario_name,
                "initial_prompt": initial_prompt,
                "original_reward_desc": reward_goal,
                "modified_reward_desc": modified_goal,
                "perturbed_prompt": f"{initial_prompt} [CRISIS MODE: {modified_goal}]",
                "complexity_level": self._calculate_complexity(initial_prompt),
                "reward_fn": {
                    "type": "portfolio_optimization",
                    "objective": reward_goal,
                    "risk_free_rate": 0.02,
                    "time_horizon": "10y"
                },
                "modified_reward_fn": {
                    "type": "portfolio_optimization",
                    "objective": modified_goal,
                    "risk_free_rate": 0.02,
                    "time_horizon": "1y"
                },
                "risk_parameters": {
                ...
                "assets": [
                    {"ticker": "SPY", "allocation": 0.6, "type": "equity"},
                    {"ticker": "AGG", "allocation": 0.3, "type": "fixed_income"},
                    {"ticker": "GLD", "allocation": 0.1, "type": "commodity"}
                ]
            }
